...
class FavoriteVC: UIViewController, UITableViewDataSource {
    ...
    func tableView(_ postTableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        let url = URL(string: "http://www.bruincave.com/files/postcount.php?type=5")!
    ...
    func tableView(_ postTableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = postTableView.dequeueReusableCell(withIdentifier: "PostCellFavorite") as! PostTableViewCell
        postDataArray.cellWidth = cell.postImage.frame.width
        let postData: PostData = postDataArray.get(index: idx, tabType: 5)
