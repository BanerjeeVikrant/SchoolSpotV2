...
//  SchoolSpot
//
//  Created by Vikrant Banerjee on 12/28/18.
//  Copyright © 2018 Vikrant Banerjee. All rights reserved.
//

import UIKit

class FreshmenVC: UIViewController, UITableViewDataSource {
    ...
    func tableView(_ postTableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        let url = URL(string: "http://www.bruincave.com/files/postcount.php?type=1")!
    ...
    func tableView(_ postTableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let postData: PostData = postDataArray.get(index: idx, tabType: 1)
