...
class JuniorVC: UIViewController, UITableViewDataSource {
    ...
    func tableView(_ postTableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        let url = URL(string: "http://www.bruincave.com/files/postcount.php?type=3")!
    ...
    func tableView(_ postTableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = postTableView.dequeueReusableCell(withIdentifier: "PostCellJunior") as! PostTableViewCell
        postDataArray.cellWidth = cell.postImage.frame.width
        let postData: PostData = postDataArray.get(index: idx, tabType: 3)
